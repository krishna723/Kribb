...
const ADMIN_PHONE="916000064395"
...
export default function PropertyDetails() {
  ...
  // console.log(property.description?.length ?? 0)
  const displayDesc= 
  expanded || !isLongDesc 
              ...
              >
                ...
                >
                  <WebView 
                    ...
                    pointerEvents='none'
                  />
                  <View className='absolute bottom-3 right-3 bg-white/80 px-3 py-1 rounded-full flex-row items-center gap-1'>
                    <Ionicons name='expand-outline' size={12} color={'#3745151'}/>
                    <Text>
                      Tap to expand
                    </Text>
                  </View>
                ...
                <TouchableOpacity 
                  ...
                  className='flex-row bg-green-600 items-center justify-center gap-2 py-4 rounded-2xl mb-4'
                  activeOpacity={0.6}>
                  ...
                  <View className='flex-row gap-2'>
                    {!property.is_sold && 
                      <TouchableOpacity 
                        ...
                        className='flex-1 flex-row items-center justify-center gap-2 bg-amber-100 py-4 rounded-2xl border-amber-200'>
                      ...
                      <TouchableOpacity 
                        ...
                        className='flex-1 flex-row items-center justify-center gap-2 bg-red-100 py-4 rounded-2xl border-red-200'>
...
function SpecItem({
  ...
  return(
    <View className='items-center gap-1'>
      ...
      <Text className='text-gray-900 font-bold tet-sm'>{value}</Text>
      <Text className='text-gray-400 text-xs'>{lable}</Text>
    </View>
  )
}